...
function Modal({ openMenu, setOpenMenu, mode, playAgain }: ModalProps) {
  ...
  return (
    <Dialog open={openMenu} onOpenChange={setOpenMenu}>
      ...
      <DialogContent className="w-[80%] bg-gradient-to-b from-governor_bay to-governor_bay_transparent shadow-home_container rounded-[4.5rem] sm:rounded-[5rem] py-28">
