    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="w-[80%] bg-gradient-to-b from-governor_bay to-governor_bay_transparent shadow-home_container rounded-[4.5rem] py-32">
        <DialogHeader className="flex flex-col justify-center items-center">
          <DialogTitle className="absolute text-6xl text-transparent tracking-wide bg-gradient-to-b from-malibu to-white bg-clip-text top-0 -mt-10">You Lose</DialogTitle>
          <DialogDescription>
            <Link to="/howtoplay">
