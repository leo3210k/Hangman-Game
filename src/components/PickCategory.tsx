...
function PickCategory() {
  ...
  return (
    <div className="min-h-svh flex flex-col items-center lg:items-baseline bg-gradient-to-b from-black_rock to-deep_koamaru px-6 pt-6 sm:px-14 sm:pt-4 lg:px-28">
